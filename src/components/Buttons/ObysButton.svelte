...
>
  <div class="relative">
    ...
    <div
      ...
      class="absolute top-1/2 -translate-y-1/2 whitespace-nowrap font-['Cormorant'] italic font-bold tracking-widest text-3xl bg-clip-text text-transparent bg-gradient-to-r from-white from-0% to-0% to-transparent"
    >
      <slot />
    </div>
  </div>
